...
function extractData(body) {
    ...
    // let element = document.querySelector("span.ds-text-tight-m.ds-font-bold.ds-text-ui-typo-primary.hover\:ds-underline.hover\:ds-decoration-ui-stroke-primary.ds-block.ds-block.ds-text-center");
    // let link = element.getAttribute("href");
    let link = "/series/ipl-2021-1249214/match-schedule-fixtures-and-results" ;  // -
